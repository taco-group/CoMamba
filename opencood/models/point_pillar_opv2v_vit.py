...
from opencood.models.fuse_modules.self_attn import AttFusion_vit
...
class PointPillarOPV2VVIT(nn.Module):
    def __init__(self, args):
        super(PointPillarOPV2VVIT, self).__init__()
        ...
        self.fusion_net = AttFusion_vit(256)
        ...
        self.estimation_performace =True
