...
def main():
    ...
    opencood_train_dataset = build_dataset(hypes, visualize=False, train=True,isSim=False)
    opencood_validate_dataset = build_dataset(hypes, visualize=False, train=False,isSim=False)
